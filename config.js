...
module.exports = {
    ...
    ALIVEMSG: process.env.ALIVE_MESSAGE === undefined ? 'I AM ALIVE! ɴᴇͥxͭᴜᷤꜱ ꜱͫɪͤʀ' : process.env.ALIVE_MESSAGE,
    ...
    BOTPLK: process.env.BOT_NAME === undefined ? 'FILO BY NEXUS' : process.env.BOT_NAME,
